...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Việt Phạm HUB') then
        makefolder('Việt Phạm HUB')
    end
    if not _G.Dis and not isfile('Việt Phạm HUB/'..Name..'.json') then
        writefile('Việt Phạm HUB/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Việt Phạm HUB') and isfile('Việt Phạm HUB/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Việt Phạm HUB/'..Name..'.json'))
...
game.StarterGui:SetCore("SendNotification", {
	Title = "Việt Phạm Hub ", 
	Text = "Việt Phạm Hub Thông Báo Nhảm Thôi Không Có Gì!\n",
	Icon = "http://www.roblox.com/asset/?id=9610159123",
	Duration = 8000
})

local win = library:Window("VietPham",[[Hub]],[[Version : Leak  ]],"9606070311",Enum.KeyCode.RightControl)
...
General_Tab:Toggle("Tự Động Buy Random Surprise","9606294253",_G.Setting_table.Farm_Random_S,function(vu)
	Farm_Random_S = vu
...
General_Tab:Toggle("Tự Động Open Color Haki","9606294253",_G.Setting_table.Farm_Ob_Color,function(vu)
	Open_Color_Haki = vu
...
General_Tab:Toggle("Tự Động Holy Torch","9606294253",_G.Setting_table.Auto_Holy_Torch,function(vu)
	Auto_Holy_Torch = vu
	_G.Setting_table.Auto_Holy_Torch = vu
	Update_Setting(getgenv()['MyName'])
end)
General_Tab:Toggle("Tự Động Grab Chest","9606294253",_G.Setting_table.Grab_Chest,function(vu)
	Grab_Chest = vu
	_G.Setting_table.Grab_Chest = vu
	Update_Setting(getgenv()['MyName'])
end)
General_Tab:Toggle("Tự Động Grab Chest Stop Torch","9606294253",_G.Setting_table.STP,function(vu)
	Grab_Chest = vu
	T_P_H = vu
...
Quest_Tab:Toggle("Tự Động Second World","9606294253",_G.Setting_table.Second_Farm,function(vu)
	Auto_New_A = vu
...
Quest_Tab:Toggle("Tự Động Bartlio","9606294253",_G.Setting_table.Bartlio_Farm,function(vu)
	Bartlio_Farm = vu
...
Quest_Tab:Toggle("Tự Động Open Swan Glass","9610159123",_G.Setting_table.Open_Don_Swan,function(vu)
	Inventory_Fruit = vu
	BringFruit = vu
	Don_Swan_Quest = vu
...
Quest_Tab:Toggle("Tự Động Third World","9606294253",false,function(vu)
	Auto_Three_World = vu
end)
spawn(function()
	while wait(.5) do
...
Quest_Tab:Toggle("Tự Động Elite Hunter","9610159123",_G.Setting_table.Auto_Elite_Hunter,function(vu)
...
Quest_Tab:Toggle("Tự Động Phoenix Awaken","9606294253",_G.Setting_table.Auto_Phoenix_Awaken,function(vu)
...
Quest_Tab:Toggle("Tự Động Observation Haki V2","9606294253",_G.Setting_table.Farm_Ken_V2,function(vu)
	Farm_Ken = vu
	Farm_Ken_V2 = vu
...
Quest_Tab:Toggle("Tự Động Superhuman","9606294253",_G.Setting_table.Superhuman,function(vu)
	_G.Setting_table.Superhuman = vu
	Update_Setting(getgenv()['MyName'])
end)
Quest_Tab:Toggle("Tự Động Death Step","9606294253",_G.Setting_table.Death_Step,function(vu)
	_G.Setting_table.Death_Step = vu
	
	Update_Setting(getgenv()['MyName'])
end)
Quest_Tab:Toggle("Tự Động Sharkman Karate","9606294253",_G.Setting_table.Sharkman_Karate,function(vu)
	_G.Setting_table.Sharkman_Karate = vu
	
	Update_Setting(getgenv()['MyName'])
end)
Quest_Tab:Toggle("Tự Động Electric Claw","9606294253",_G.Setting_table.Electric_Claw,function(vu)
	_G.Setting_table.Electric_Claw = vu
	
	Update_Setting(getgenv()['MyName'])
end)
Quest_Tab:Toggle("Tự Động Dragon Talon","9606294253",_G.Setting_table.Dragon_Talon,function(vu)
...
Quest_Tab:Toggle("Tự Động Mink Evo V0 - V3","9606294253",_G.Setting_table.Mink_Evo,function(vu)
	_G.Setting_table.Mink_Evo = vu
	Update_Setting(getgenv()['MyName'])
end)
Quest_Tab:Toggle("Tự Động Human Evo V0 - V3","9606294253",_G.Setting_table.Human_Evo,function(vu)
	_G.Setting_table.Human_Evo = vu
	Update_Setting(getgenv()['MyName'])
end)
Quest_Tab:Toggle("Tự Động Skypiea Evo V0 - V3","9606294253",_G.Setting_table.Skypiea_Evo,function(vu)
	_G.Setting_table.Skypiea_Evo = vu
	Update_Setting(getgenv()['MyName'])
end)
Quest_Tab:Toggle("Tự Động Fish Evo V0 - V3","9606294253",_G.Setting_table.Fishman_Evo,function(vu)
...
Quest_Tab:Label("Gun")
Quest_Tab:Toggle("Tự Động Acidum Rifle","9610159123",_G.Setting_table.Auto_Acidum_Rifle,function(vu)
...
Quest_Tab:Toggle("Tự Động Serpent Bow","9610159123",_G.Setting_table.Auto_Serpent_Bow,function(vu)
	Auto_Serpent_Bow = vu
...
Quest_Tab:Toggle("Tự Động Dark Coat","9606294253",_G.Setting_table.Auto_Dark_Coat,function(vu)
	Auto_Dark_Coat = vu
...
Quest_Tab:Toggle("Tự Động Swan Glass","9610159123",_G.Setting_table.Auto_Swan_Glass,function(vu)
	Auto_Swan_Glass = vu
...
Quest_Tab:Toggle("Tự Động Pale Scarf","9606294253",_G.Setting_table.Auto_Pale_Scarf,function(vu)
	Auto_Pale_Scarf = vu
...
Quest_Tab:Toggle("Tự Động Valkyrie Helmet","9610159123",_G.Setting_table.Auto_Valkyrie_Helmet,function(vu)
...
Quest_Tab:Toggle("Tự Động Saber","9606294253",_G.Setting_table.Saber_Farm,function(vu)
	Saber_Farm = vu
...
Quest_Tab:Toggle("Tự Động Pole V1","9610159123",_G.Setting_table.Pole_Farm,function(vu)
	Pole_Farm = vu
...
Quest_Tab:Toggle("Tự Động Rengoku","9606294253",_G.Setting_table.Rengoku_A,function(vu)
	Rengoku_A = vu
...
Quest_Tab:Toggle("Tự Động Ko Ko","9606294253",false,function(vu)
	if vu then
		Text("ยังไม่ทำ")
	end
end)
Quest_Tab:Toggle("Tự Động Dragon Trident","9610159123",_G.Setting_table.Auto_Dragon_Trident,function(vu)
...
Quest_Tab:Toggle("Tự Động True Triple Katana","9606294253",_G.Setting_table.Triple_A,function(vu)
	Auto_Farm_Sword = vu
	Triple_A = vu
...
Quest_Tab:Toggle("Tự Động Yama","9610159123",_G.Setting_table.Auto_Yama,function(vu)
	Auto_Yama = vu
...
Quest_Tab:Toggle("Tự Động Tushita","9610159123",_G.Setting_table.Auto_Tushita,function(vu)
	Auto_Tushita = vu
...
Quest_Tab:Toggle("Tự Động Twin Hooks","9610159123",_G.Setting_table.Auto_Twin_Hooks,function(vu)
	Auto_Twin_Hooks = vu
...
Quest_Tab:Toggle("Tự Động Canvander","9610159123",_G.Setting_table.Auto_Canvander,function(vu)
	Auto_Canvander = vu
...
Quest_Tab:Toggle("Tự Động Buddy Sword","9610159123",_G.Setting_table.Auto_Buddy_Sword,function(vu)
	Auto_Buddy_Sword = vu
...
Quest_Tab:Toggle("Tự Động Spikey Trident","9606294253",_G.Setting_table.Auto_Spikey_Trident,function(vu)
...
Quest_Tab:Toggle("Tự Động Hallow Scryte","9606294253",_G.Setting_table.Auto_Hallow_Scryte,function(vu)
...
Quest_Tab:Toggle("Tự Động Dark Dagger","9610159123",_G.Setting_table.Auto_Dark_Dagger,function(vu)
	Auto_Dark_Dagger = vu
...
PvP_Tab:Label("Misc")
PvP_Tab:Toggle("Tự Động PvP Turn On","9606294253",_G.Setting_table.Auto_PvP_Turn_On,function(vu)
...
PvP_Tab:Toggle("Tự Động Teleport To Position Spawn","9606294253",_G.Setting_table.TP_Position_Spawn,function(vu)
...
Raid_Tab:Label("Main")
Raid_Tab:Toggle("Tự Động Raid Hop","9606294253",_G.Setting_table.Auto_Raid_Hop,function(vu)
	Auto_Raid = vu
	_G.Setting_table.Auto_Raid_Hop = vu
	Update_Setting(getgenv()['MyName'])
end)
Raid_Tab:Toggle("Tự Động Raid","9606294253",_G.Setting_table.Auto_Raid,function(vu)
	Auto_Raid = vu
...
Raid_Tab:Toggle("Tự Động Awaken","9606294253",_G.Setting_table.Auto_Awaken,function(vu)
...
Shop_Tab:Label("Main")
Shop_Tab:Toggle("Tự Động Buy Legendary Sword","9606294253",_G.Setting_table.Auto_Buy_Legendary_Sword,function(vu)
...
Shop_Tab:Toggle("Tự Động Buy Random Fruit","9606294253",_G.Setting_table.Auto_Buy_Random_Fruit,function(vu)
...
Shop_Tab:Button("Buy ElectricClaw",function()
	...
	Shop_Tab:Toggle("Tự Động Buy Random Surprise","9606294253",_G.Setting_table.Auto_Random,function(vu)
		_G.Auto_Random = vu
...
Shop_Tab:Toggle("Tự Động Buy Color Buso Haki","9606294253",_G.Setting_table.Buso_Haki,function(vu)
...
Status_Tab:Toggle("Tự Động Update Status","9606294253",_G.Setting_table.Update_S,function(vu)
...
Setting_Tab:Toggle("Tự Động Rejoin On Kick","9606294253",_G.Setting_table.Rejoin,function(vu)
	_G.Rejoin = vu
...
Setting_Tab:Toggle("Tự Động Buso Haki","9606294253",true,function(vu)
...
Setting_Tab:Toggle("Tự Động Ken Haki","9606294253",_G.Setting_table.Auto_Ken,function(vu)
...
Hop_Tab:Toggle("Tự Động Buy Legendary Sword Hop","9606294253",_G.Setting_table.Auto_Buy_Legendary_Sword_Hop,function(vu)
	_G.Setting_table.Auto_Buy_Legendary_Sword = vu
...
Hop_Tab:Toggle("Tự Động Buy Color Buso Haki Hop","9606294253",_G.Setting_table.Buso_Haki_Hop,function(vu)
	Buso_Haki_Buy = vu
...
Hop_Tab:Label("Quest")
Hop_Tab:Toggle("Tự Động Open Don Swan Hop","9606294253",_G.Setting_table.Open_Don_Swan_Hop,function(vu)
	Inventory_Fruit = vu
	BringFruit = vu
	Don_Swan_Quest = vu
...
Hop_Tab:Toggle("Tự Động Phoenix Awaken Hop","9606294253",false,function(vu)
	_G.Setting_table.Phoenix_Hop = vu
	Update_Setting(getgenv()['MyName'])
end)
Hop_Tab:Toggle("Tự Động Observation Haki V2 Hop","9606294253",_G.Setting_table.Farm_Ken_V2_Hop,function(vu)
	Farm_Ken = vu
	Farm_Ken_V2 = vu
...
Hop_Tab:Label("Sword")
Hop_Tab:Toggle("Tự Động Pole V1 Hop","9606294253",_G.Setting_table.Pole_V1_Hop,function(vu)
	Pole_Farm = vu
...
Hop_Tab:Toggle("Tự Động Saber Hop","9606294253",_G.Setting_table.Saber_Farm_Hop,function(vu)
	Saber_Farm = vu
...
Hop_Tab:Toggle("Tự Động Rengoku Hop","9606294253",_G.Setting_table.Rengoku_Hop,function(vu)
	Rengoku_A = vu
...
Hop_Tab:Toggle("Tự Động Ko Ko Hop","9606294253",false,function(vu)
	
end)
Hop_Tab:Toggle("Tự Động Dragon Trident Hop","9606294253",_G.Setting_table.Auto_Dragon_Trident_Hop,function(vu)
	Auto_Dragon_Trident = vu
...
Hop_Tab:Toggle("Tự Động True Triple Katana Hop","9606294253",_G.Setting_table.Triple_Hop,function(vu)
	Triple_A = vu
	Auto_Farm_Sword = vu
...
Hop_Tab:Toggle("Tự Động Yama Hop","9606294253",_G.Setting_table.Auto_Yama_Hop,function(vu)
	Auto_Yama = vu
...
Hop_Tab:Toggle("Tự Động Tushita Hop","9606294253",_G.Setting_table.Auto_Tushita_Hop,function(vu)
	Auto_Tushita = vu
...
Hop_Tab:Toggle("Tự Động Twin Hooks Hop","9606294253",_G.Setting_table.Auto_Twin_Hooks_Hop,function(vu)
	Auto_Twin_Hooks = vu
...
Hop_Tab:Toggle("Tự Động Canvander Hop","9606294253",_G.Setting_table.Auto_Canvander_Hop,function(vu)
	Auto_Canvander = vu
...
Hop_Tab:Toggle("Tự Động Buddy Sword Hop","9606294253",_G.Setting_table.Auto_Buddy_Sword_Hop,function(vu)
	Auto_Buddy_Sword = vu
...
Hop_Tab:Toggle("Tự Động Spikey Trident Hop","9606294253",_G.Setting_table.Spikey_Trident_Hop,function(vu)
	Auto_Spikey_Trident = vu
...
Hop_Tab:Toggle("Tự Động Hallow Scryte Hop","9606294253",_G.Setting_table.Auto_Hallow_Scryte,function(vu)
	Auto_Hallow_Scryte = vu
...
Hop_Tab:Toggle("Tự Động Dark Dagger Hop","9606294253",_G.Setting_table.Auto_Dark_Dagger_Hop,function(vu)
	Auto_Dark_Dagger = vu
...
Hop_Tab:Label("Gun")
Hop_Tab:Toggle("Tự Động Acidum Rifle Hop","9606294253",_G.Setting_table.Auto_Acidum_Rifle_Hop,function(vu)
	Auto_Acidum_Rifle = vu
...
Hop_Tab:Toggle("Tự Động Serpent Bow Hop","9606294253",_G.Setting_table.Auto_Serpent_Bow_Hop,function(vu)
	Auto_Serpent_Bow = vu
...
Hop_Tab:Toggle("Tự Động Dark Coat Hop","9606294253",_G.Setting_table.Auto_Dark_Coat_Hop,function(vu)
	Auto_Dark_Coat = vu
...
Hop_Tab:Toggle("Tự Động Swan Glass Hop","9606294253",_G.Setting_table.Auto_Swan_Glass_Hop,function(vu)
	Auto_Swan_Glass = vu
...
Hop_Tab:Toggle("Tự Động Pale Scarf Hop","9606294253",false,function(vu)
	Auto_Pale_Scarf = vu
...
Hop_Tab:Toggle("Tự Động Valkyrie Helmet Hop","9606294253",_G.Setting_table.Auto_Valkyrie_Helmet_Hop,function(vu)
	Auto_Valkyrie_Helmet = vu
